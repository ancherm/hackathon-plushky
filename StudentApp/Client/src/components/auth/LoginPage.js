...
class LoginPage extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.props.loginError.hasError && prevProps.loginError !== this.props.loginError) {
            ...
            toast.success(<ToastComponent.successToast text={'Вы успешно вошли в систему!'} />, {
                position: toast.POSITION.TOP_RIGHT
            });
        ...
        return (
            <section className="pt-3">
                <div className="container login-form-content-section pb-4 " >
                    <h1 className="text-center font-weight-bold mt-4" style={{ 'margin': '1rem auto', 'paddingTop': '2rem' }}>Войти</h1>
                    ...
                    <form className="Login-form-container" onSubmit={this.onSubmitHandler}>
                        <div className="form-group">
                            ...
                            />
                            {shouldMarkError('username') && <small id="usernameHelp" className="form-text alert alert-danger">Требуется имя пользователя!</small>}
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            />
                            {shouldMarkError('password') && <small id="passwordHelp" className="form-text alert alert-danger">Требуется пароль!</small>}
                        </div>

                        <div className="text-center">
                            <button disabled={!isEnabled} type="submit" className="btn App-button-primary btn-lg m-3">Войти</button>
                        </div>
                    </form>
                </div>
            </section>
