                ...
                <article className="main-article-shared-content">
                    <section className="profile-content-section">
                        <div className="container col-md-10 text-center mb-4">
                            <h1 className="text-center font-weight-bold mt-4" style={{ 'margin': '1rem auto' }}>Все пользователи</h1>
                            <table className="table table-hover mt-3 w-80 mx-auto text-center">
                                <thead>
                                    <tr className="row">
                                        <th className="col-md-1" scope="col">#</th>
                                        <th className="col-md-2" scope="col">Имя пользователя</th>
                                        <th className="col-md-2" scope="col">Роль</th>
                                        <th className="col-md-7" scope="col">Действия</th>
                                    </tr>
                                </thead>
                                <tbody>
