...
class UserDeletePage extends Component {
    ...
    getErrorMessage(prevProps) {
        if (this.props.deleteUser.hasError && prevProps.deleteUser.error !== this.props.deleteUser.error) {
            return this.props.deleteUser.message || 'Ошибка сервера';
        }
                ...
                <article className="main-article-shared-content">
                    <section className="delete-content-section">
                        <div className="container mx-auto text-center mb-4" >
                            <h1 className="text-center font-weight-bold alert alert-danger position col-md-10 mt-4" style={{ 'margin': '1.5rem auto' }}>Вы уверены, что хотите удалить этого пользователя?</h1>
                            <div className="col-md-6 mx-auto text-center">
                                    ...
                                    <tbody>
                                        <tr className="row">
                                            <td className="col-md-6">
                                                <h5 className=" font-weight-bold">Имя пользователя</h5>
                                            </td>
                                        ...
                                        <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Имя</h5>
                                            </td>
                                            <td className="col-md-6" >
                                        ...
                                        <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Фамилия</h5>
                                            </td>
                                            <td className="col-md-6" >
                                        ...
                                        <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Город</h5>
                                            </td>
                                            <td className="col-md-6" >
                                        ...
                                        {(isAdmin || isRoot) && <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Роль</h5>
                                            </td>
                                            <td className="col-md-6" >
                                                <h5>{authority}</h5>
                                            </td>
                                ...
                                <div className="d-flex justify-content-center ">
                                    {(isAdmin || isRoot) && <ButtonWithClickEvent buttonClass={"btn App-button-primary btn-lg m-3"} url={`/home/users/delete/`} text={"Удалить"} onClick={this.onSubmitHandlerDelete} />}
                                    {(isAdmin || isRoot) && <NavLink className="btn App-button-primary btn-lg m-3" to={`/home/profile/${this.props.id}`} role="button">Отмена</NavLink>}
                                    {(isAdmin || isRoot) && <Button buttonClass={"btn App-button-primary btn-lg m-3"} url={`/home/users/all/${userService.getUserId()}`} text={"Все пользователи"} />}
                                </div >
                            </div >
